...
data_manager = DataManager(
    sheet_price_endpoint="https://api.sheety.co/aeb1591f06cb7a8efe02d5d69255043d/flightDeals/prices",
sheet_users_endpoint="https://api.sheety.co/aeb1591f06cb7a8efe02d5d69255043d/flightDeals/users")

flight_search = FlightSearch(tequila_endpoint="https://tequila-api.kiwi.com")
